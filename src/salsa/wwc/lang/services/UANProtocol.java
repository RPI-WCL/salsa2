...
public class UANProtocol {
	...
	public static final String UPDATE_REQUEST_CODE = "UPD";
    ...
    public static String UPDATE_STATUS_STR = "Entry UPDATED";

	public static String BAD_REQUEST_STATUS_STR = "Bad Request";
	public static String NOT_FOUND_STATUS_STR = "Name Not Found";
	public static String DUPLICATED_UAN_STR = "UAN Has Been Registered";
	
	public static String PSUDO_STR = "P";
}
